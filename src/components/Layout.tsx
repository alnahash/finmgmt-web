...
import { LayoutDashboard, TrendingDown, Layers, Target, BarChart3, TrendingUp, Settings, LogOut, Shield, Sparkles, Lightbulb, ChevronLeft, ChevronRight, Menu } from 'lucide-react'
    ...
    <div className="flex h-screen bg-slate-950">
      ...
      <div className={`${sidebarOpen ? 'w-64' : 'w-0'} bg-slate-900 border-r border-slate-800 flex flex-col transition-all duration-300 overflow-hidden`}>
        ...
        <div className="p-6 border-b border-slate-800 flex items-center justify-between">
          <img src="/logo/astiq-logo.svg" alt="Astiq" className="h-20" />
          <button
